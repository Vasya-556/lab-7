...
int main()
{
    ...
    do
    {
        cout << "[1] - Determine the degree of vertices of the graph" << endl;
        cout << "[2] - Save the degree of vertices of the graph" << endl;
        cout << "[3] - Display all isolated and hanging vertices" << endl;
        cout << "[4] - Regular index" << endl;
        cout << "[0] - Exit" << endl;
        cin >> menu;
        switch (menu)
        {
...
string Degree() {
    ...
    result << "| V " << "| in-degree " << "| out-degree |" << endl;
    for (int i = 0; i < vertices; i++)
    {
...
string isolated() {
    ...
    res << "| Isolated vertices | Hanging vertices |" << endl;
